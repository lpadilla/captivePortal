...
(function($){
  if(navigator.onLine == true){
    ...
    var url_plans = $("#url_plans").attr('href');

    if( msisdn != undefined && msisdn != null && 
        balance != undefined && balance != null &&
        url_plans != undefined && url_plans != null
    ){
      localStorage.setItem("msisdn", msisdn);
      localStorage.setItem("balance", balance);
      localStorage.setItem("url_plans", url_plans);    
    }
  }else{
    $("#msisdn").text(localStorage.getItem("msisdn"));
    $("#balance").text(localStorage.getItem("balance"));
    $("#url_plans").attr('href', localStorage.getItem("url_plans"));
    $('#alert').show();
  }
})(jQuery);